...
* This week I have subsetted my data into training and test sets that can be used for K-fold cross validation. I have explained my steps at [The Data] in the last story.  
* Furthermore I have finally made some classification models on the _track features_ data! The results can be found at [Modeling (Week 11 update)].
...
Testing the Models on Novel Data
===
