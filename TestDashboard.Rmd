...
### __The 'Special Song'__<br/>I look for a new song produced by one of the artists to use for creating ceptstrogram and self-similarity matrix.

```{r}
bzt <- 
    get_tidy_audio_analysis('5ZLkc5RY1NM4FtGWEd6HOE') %>% # HIER NOG DE URI VAN EEN SONG!!!
...
### __Self-Similarity Matrix of [song]__
